    ...
    $result = $stmt->get_result();
        ...
        if (password_verify($password, $row['password']) || md5($password) === $row['password']) {
            ...
            if ($isClearlyUnverified) {
                $resendUrl = "../Auth/resend_verification.php?role=customer&email=" . urlencode($email);
        ...
        $error_message = "No customer account found with this email address.";
    }
}
        ...
        <div class="row">
            <div class="col">
                <div class="content-wrapper">
                    ...
                    <p class="text-center">Welcome back! Please login to access your account.</p>
                    ...
                    <div class="row">
                        <div class="col-half" style="margin: 0 auto;">
                            ...
                            <div class="text-center mt-3">
                                <p><a href="../Auth/forgot_password.php?role=customer">Forgot your password?</a></p>
                                <p>Don't have an account? <a href="register.php">Register here</a></p>
                                <p>Are you a service provider? <a href="../provider/login.php">Provider Login</a></p>
