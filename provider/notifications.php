...
$conn->query("UPDATE notifications SET is_read = TRUE WHERE user_id = $provider_id");
    ...
    <div class="container">
        <div class="content-wrapper">
            <div class="page-header">
                ...
                <p>Stay updated with booking requests and important updates</p>
            </div>

            <?php
            $notifs = $conn->query("SELECT * FROM notifications WHERE user_id=$provider_id ORDER BY created_at DESC LIMIT 50");
            ...
            if ($notifs->num_rows > 0) {
                ...
                echo "<p class='text-secondary'>Your notifications will appear here when customers book your services or other important updates occur.</p>";
